            ...
            mAuth.createUserWithEmailAndPassword(email, password)
                .addOnCompleteListener{task ->
                    if (task.isSuccessful)
                    {
                        ...
                        userHashMap["profile"] = "https://firebasestorage.googleapis.com/v0/b/messengerapp-a928e.appspot.com/o/profile.png?alt=media&token=bdda270c-8feb-434c-af0c-8a0be8486ddd"
                        userHashMap["cover"] = "https://firebasestorage.googleapis.com/v0/b/messengerapp-a928e.appspot.com/o/profile.png?alt=media&token=bdda270c-8feb-434c-af0c-8a0be8486ddd"
